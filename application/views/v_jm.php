                ...
                <ul class="navbar-nav ml-auto d-flex align-items-center">
                        ...
                        <li class="nav-item dropdown active"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">CATEGORY</a>
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <a class="dropdown-item active bg-orange" href="<?php echo base_url();?>jm">Jurnal/Makalah</a>
                            </div>
...
<div class="jumbotron jumbotron-md jumbotron-fluid overlay overlay-blue" style=" background-image:url(assets/img/demo/jm.jpeg); background-position: center center; background-size:cover; background-repeat: no-repeat; background-attachment: fixed;">
