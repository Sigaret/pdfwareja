            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown-1">
                <div class="col-lg-5">
                    <ul class="navbar-nav md-12 .mr-auto">                                                        
                        ...
                        <!--  -->                                
                                <input type="text" class ="form-control iput input-round" name="search"  placeholder="Search With Title Or Category">                                                                
                ...
                <ul class="navbar-nav ml-auto d-flex align-items-center">
                        <li class="nav-item active"><a class="nav-link" href="<?php echo base_url();?>" id="home">HOME <span class="sr-only">(current)</span></a></li>
                        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">CATEGORY</a>
                            ...
                            <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>donate" id="donate">DONATE <span class="fa fa-heart"></span> </a></li>
                        </li>
                <!-- </ul> -->
                <!-- <ul class=""> -->
                      ...
                      <h2 class="mt-5"> Result :</h2>
                        ...
                        <div class="col-lg-12 info-panel">                                
                            <div class="row">
                              ...
                              <div class="col-lg-9">
                                  <a><h4 ><?php echo $r->judul_b; ?></h4></a> 
                                  <p><?php echo $r->abstrak;?>.</p>                                          
                                      <label> <span class="fa fa-user-circle "></span> <?php echo $r->nama ?> | Category : <?php echo $r->nama_kat; ?> | <span class="fa fa-eye"></span> <?php echo $r->viewed; ?>  </label>
                                      <br>
                                  ...
                                  <?php
                                      ...
                                      <br>
                                      <a href="<?php echo base_url();?>home/download/<?php echo $r->id_berkas?>" class="btn btn-outline-navy btn-round"> <span class="fa fa-download"></span> Download</a>
                                      <a href="<?php echo base_url();?>viewer_pdf/tampil_c/<?php echo $r->id_berkas?>" class="btn btn-outline-orange btn-round"> <span class="fa fa-file"></span> Preview</a>
                              </div> 
                              </div>
                        </div>                        
                        <!-- END Foreach -->
