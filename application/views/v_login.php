                ...
                <div class="col-lg-8"> 
                  <!-- Foreach --> 
                    <div class="col-lg-12 info-panel">
                            <form actio="<?php echo base_url('login') ?>" class="border rounded p-5" method='post'>
                                    <h3 class="mb-4 text-center">Sign In</h3>
                                    <?php echo $this->session->flashdata('great'); ?>
                                    <div class="form-group">
                                        <div class="input-group mb-2 mr-sm-2">
                                                <div class="input-group-prepend">
                                                        <div class="input-group-text"><span  class="fas fa-envelope prefix" ></span></div>
                                                </div>
                                                <input type="text" class="form-control ipcyan" name="email" id="exampleInputPassword1" placeholder="E-mail"value="<?php echo set_value('email') ?>">                                                
                                            </div>
                                    ...
                                    <button type="submit" class="btn btn-orange btn-round btn-block shadow-sm">Sign in</button>
                                    <!-- <small class="d-block mt-4 text-center"><a class="text-gray" href="#signup" data-toggle="tab"  >Dont have account ?</a></small> -->
                                    <div class="form-group mt-4">                                            
                                        <a href="<?php echo base_url('login/register')?> " style="color: blue;">Not Registered Yet ? Click This Link For Register</a>
                                    </div>
                            </form>                                
                    </div>
                </div>                        
