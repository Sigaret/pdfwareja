...
<script src="https://kit.fontawesome.com/0eaf1ef1fb.js" crossorigin="anonymous"></script>
                ...
                <ul class="navbar-nav ml-auto d-flex align-items-center">
                        ...
                        <li class="nav-item dropdown active"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">CATEGORY</a>
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <a class="dropdown-item active bg-orange" href="<?php echo base_url();?>modul">Modul</a>
...
<div class="jumbotron jumbotron-md jumbotron-fluid overlay overlay-blue" style="background-image:url(assets/img/demo/modul2.jpg); background-position: center center; background-size:cover; background-repeat: no-repeat; background-attachment: fixed;">
	<div class="container text-center text-white h-100">
		<h1 class="display-2">MATERI KULIAH</h1>
		<h5 class="font-weight-light mt-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis quas nihil quia. Voluptatum, vitae rem. Officiis dolorum expedita error accusantium! Animi fuga minima dolor sint ullam. Quas quidem ducimus accusamus quod iste adipisci, doloremque sequi nisi quisquam, aliquid illo necessitatibus!</h5>
	</div>
