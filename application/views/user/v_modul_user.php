                ...
                <ul class="navbar-nav ml-auto d-flex align-items-center">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <a class="dropdown-item active" href="<?php echo base_url();?>user/modul_user">Modul</a>
...
<div class="jumbotron jumbotron-md jumbotron-fluid overlay overlay-blue" style="background-image:url(<?php echo base_url();?>assets/img/demo/modul2.jpg);background-position: center center; background-size:cover; background-repeat: no-repeat; background-attachment: fixed;"> 
	<div class="container text-center text-white h-100">
		<h1 class="display-2"><strong>MATERI<br> PERKULIAHAN</strong></h1>
