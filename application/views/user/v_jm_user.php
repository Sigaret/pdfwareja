...
<title> Jurnal/Makalah · PDF-Wareja</title>
                ...
                <ul class="navbar-nav ml-auto d-flex align-items-center">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <a class="dropdown-item active" href="<?php echo base_url();?>user/jm_user">Jurnal/Makalah</a>
                            </div>
...
<div class="jumbotron jumbotron-md jumbotron-fluid overlay overlay-blue" style="background-image:url(<?php echo base_url();?>assets/img/demo/jm.jpeg); background-position: center center; background-size:cover; background-repeat: no-repeat; background-attachment: fixed;"> ">
	<div class="container text-center text-white h-100">
		<h1 class="display-2"><strong>JURNAL <br>/ MAKALAH</strong></h1>
