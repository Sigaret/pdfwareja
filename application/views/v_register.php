...
<title>Register.PDF-Wareja</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown-1">
                ...
                <!-- <ul class=""> -->
                        ...
                        <a class="btn btn-navy btn-round text-light" href="<?php echo base_url('login') ?>"><i class="fas fa-sign-in-alt"></i> Sign</a>  
                        </span>
                        </li>
                </ul>
            </div>
                        ...
                        <h3 class="mb-4 text-center">Sign Up</h3> 
                            <div class="form-group">
                                 <div class="input-group mb-2 mr-sm-2">
                                    ...
                                    <div class="input-group-text"><span  class="fas fa-user prefix" ></span></div>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-orange btn-round btn-block shadow-sm">Sign Up</button>
